                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="thumbnail text-center">
                            <img src="image/1.jpg" alt="Astrid Anissa Rahma Oktora" title="Astrid Anissa Rahma Oktora">
                            <div class="caption">
                                <h3>Selamat Ulang Tahun</h3>
                                <h3>Astrid Anissa Rahma Oktora</h3>
                                ...
                                <h3 class="text-center">
                                    ...
                                    <strong>
                                        ...
                                        <script>
                                            ...
                                            var countDownDate = new Date("Oktober 23, 2023 00:00:00").getTime();
